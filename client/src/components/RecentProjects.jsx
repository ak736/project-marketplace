...
const RecentProjects = () => {
  ...
  return (
    <div className='mt-10 border border-gray-500 dark:border-gray-300 dark:bg-gray-800 rounded-lg p-6'>
        ...
        <h2 className='font-semibold dark:text-gray-300'>Recent Projects</h2>
        ...
        <div className='flex mt-6 gap-4 justify-evenly flex-wrap '>
            <div className='max-w-[190px] overflow-hidden'>
                ...
                <p className='mt-2 truncate text-sm dark:text-gray-300'>3d Website with Three.js | React</p>
                <p className='text-sm dark:text-gray-300'>Price: <span className='font-semibold'>$1200</span></p>
            </div>
            <div className='max-w-[190px] overflow-hidden'>
                <img src="https://i.ytimg.com/vi/0fYi8SGA20k/hqdefault.jpg?sqp=-oaymwEXCNACELwBSFryq4qpAwkIARUAAIhCGAE=&rs=AOn4CLDWce0k5XmT0oYgy1xdoRsioH_u5A" alt="Thumbnail" className=' rounded-lg object-cover' />
                <p className='mt-2 truncate text-sm dark:text-gray-300'>3d Website with Three.js | React</p>
