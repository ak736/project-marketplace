...
const Wave = () => {
  const darkMode = useSelector((state) => state.darkMode);
    ...
    const svgColor = darkMode ? '#374151' : '#FFFFFF';
  return (
...
>
  <path
    ...
    className="shape-fill b"
    style={{ fill: svgColor }}// Set the fill color to dark gray-700
  ></path>
</svg>

      <div className={`flex items-center justify-center gap-6 ${darkMode? `bg-gray-700`:`bg-white`}  pb-10`}>
